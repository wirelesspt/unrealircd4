...
MOD_LOAD(m_textshun) {
	EventAddEx(textshunMI->handle, "textshun_event", 10, 0, textshun_event, NULL); // Run event every 10 seconds, indefinitely and without any additional data (void *NULL etc)
